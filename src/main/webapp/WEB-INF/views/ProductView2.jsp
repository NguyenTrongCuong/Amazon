...
<head>
	...
	<script type="text/javascript" src='<spring:url value="/clientjs/js/ProductView2.js"/>'></script>
</head>
<body>
	<h1>Product list</h1>
	<p>Filter</p>
	<form action="getSortedProduct" method="POST">
		...
		<input type="hidden" id="categoryFilter" value="${sessionScope.categoryFilter}"/>
		<input type="hidden" id="productFilter" value="${sessionScope.productFilter}"/>
	...
	<button><a href="http://localhost:8080/Amazon/clientService/removeFilters?productType=${productType}">Remove filters</a></button><br/><br/>
	...
	<c:if test="${pageNumber < totalPages}">
		<button><a href="http://localhost:8080/Amazon/clientService/getSortedProductNextPage?productType=${productType}&nextOrPrevious=next">Next</a></button>
	</c:if>
	<c:if test="${pageNumber > 1}">
		<button><a href="http://localhost:8080/Amazon/clientService/getSortedProductNextPage?productType=${productType}&nextOrPrevious=previous">Previous</a></button>
	</c:if>
</body>
</html>
